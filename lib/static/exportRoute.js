      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 67:
            ...
            htmlFilename = _path.default.join(config.paths.DIST, route.path, 'index.html');
