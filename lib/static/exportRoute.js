      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 67:
            ...
            htmlFilename = route.path === '404' ? _path.default.join(config.paths.DIST, '404.html') : _path.default.join(config.paths.DIST, route.path, 'index.html');
            _context.next = 74;
