      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 67:
            ...
            _htmlFilename = _path.default.join(config.paths.DIST, route.path, 'index.html'); // Make the routeInfo sit right next to its companion html file

            routeInfoFilename = _path.default.join(config.paths.DIST, route.path, 'routeInfo.json');
            _context.next = 76;
            return Promise.all([_fsExtra.default.outputFile(_htmlFilename, html), !route.redirect ? _fsExtra.default.outputJson(routeInfoFilename, routeInfo) : Promise.resolve()]);
          ...
          case 79:
            _context.next = 81;
            return Promise.all([_fsExtra.default.outputFile(htmlFilename, html)]);
