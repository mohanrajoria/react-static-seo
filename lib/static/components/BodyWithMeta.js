...
var generateRouteInformation = function generateRouteInformation() {
  return {
    __html: "\n    window.__routeInfo = ".concat(JSON.stringify({}).replace(REGEX_FOR_SCRIPT, '<"+"$1$2'), ";")
  };
...
var makeBodyWithMeta = function makeBodyWithMeta(_ref) {
  ...
  return function (_ref2) {
    ...
    return _react.default.createElement("body", _extends({}, head.bodyProps, rest, {
      ...
      __self: this
    }), children, !route.redirect && route.path === '404' && _react.default.createElement("script", {
      ...
      __self: this
    }), !route.redirect && route.path === '404' && clientScripts.map(function (script) {
