...
var makeBodyWithMeta = function makeBodyWithMeta(_ref) {
  ...
  return function (_ref2) {
    ...
    return _react.default.createElement("body", _extends({}, head.bodyProps, rest, {
      ...
      __self: this
    }), children, !route.redirect && (route.path === '404' || route.path.indexOf('providers/') === 0) && _react.default.createElement("script", {
      ...
      __self: this
    }), !route.redirect && (route.path === '404' || route.path.indexOf('providers/') === 0) && clientScripts.map(function (script) {
